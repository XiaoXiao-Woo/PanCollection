...
class parser_args(TaskDispatcher, name='InvFormer'):
    def __init__(self, cfg=None, **kwargs):
        ...
        parser.add_argument('--samples_per_gpu', default=4, type=int,  # 8
        ...
        ##
        parser.add_argument('--arch', '-a', metavar='ARCH', default='InvFormer', type=str)
