...
class parser_args(TaskDispatcher, name='pan_unfolding'):
    def __init__(self, cfg=None):
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='pan_unfolding', type=str,
        ...
        parser.add_argument('--middle_channels', default=8, type=int)
        parser.add_argument('--out_channels', default=4, type=int)
        parser.add_argument('--n_resblocks', default=2, type=int)
        parser.add_argument('--res_scale', default=1, type=int)
