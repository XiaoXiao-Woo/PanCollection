...
class parser_args(TaskDispatcher, name='PZResNet'):
    def __init__(self, cfg=None):
        ...
        model_path = f'{root_dir}/Weights/{cfg.task}/PZResNet/.pth.tar'
        ...
        # * Model and Dataset
        parser.add_argument('--arch', '-a', metavar='ARCH', default='PZResNet', type=str,
